...
namespace MvcSf.Controllers
{
    public class OrdersAdminController : Controller
    {
        ...
        public ActionResult Details(int id)
        {
            ...
            //}
            //OrderTable oList = oRepo.GetOrders().Where(o => o.OrderID == id).FirstOrDefault();
            return RedirectToAction("Index", "OrderAdminDetails", new { id = id });
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            //    return HttpNotFound();
            //}
            return RedirectToAction("Index", "OrderAdminDetails", id);
        }
        ...
        {
            OrderTable orderTable = db.OrderTable.Find(id);
            var opt = db.OrderProductTable.Where(o => o.OrderID == orderTable.OrderID).Select(o => o).ToList();
            for(int l = 0; l < opt.Count(); l++)
            {
                db.OrderProductTable.Remove(opt[l]);
            }
